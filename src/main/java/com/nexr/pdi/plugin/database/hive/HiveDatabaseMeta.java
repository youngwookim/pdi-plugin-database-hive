...
public class HiveDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
    ...
    public String getAddColumnStatement(String tablename, ValueMetaInterface v, String tk,
    ...
    public String getFieldDefinition(ValueMetaInterface v, String tk, String pk,
